...
ColumnLayout{
    ...
    Rectangle{
        ...
        ListView{
            ...
            clip: true
            onCurrentIndexChanged: mediaManager.setCurrentSelectedMediaIndex(currentIndex)
            delegate: Rectangle{
                ...
                Rectangle{
                    ...
                    height: 2
                    color: (mediaManager.currentPlayingMediaIndex === index) ? Material.color(Material.Purple, Material.Shade500) : Material.color(Material.Grey, Material.Shade700)
                }
                MouseArea{
                    anchors.fill: parent
                    onReleased: {
